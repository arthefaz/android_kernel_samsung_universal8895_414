...
enum clk_id cmucal_vclk_lhs_axi_p_apm[] = {
	GOUT_BLK_BUS1_UID_LHS_AXI_P_APM_IPCLKPORT_I_CLK,
};
...
enum clk_id cmucal_vclk_ad_apb_dspm2[] = {
...
enum clk_id cmucal_vclk_ad_apb_dspm5[] = {
	GOUT_BLK_DSPM_UID_AD_APB_DSPM5_IPCLKPORT_PCLKM,
	GOUT_BLK_DSPM_UID_AD_APB_DSPM5_IPCLKPORT_PCLKS,
};
...
enum clk_id cmucal_vclk_ad_axi_dspm1[] = {
	GOUT_BLK_DSPM_UID_AD_AXI_DSPM1_IPCLKPORT_ACLKM,
	GOUT_BLK_DSPM_UID_AD_AXI_DSPM1_IPCLKPORT_ACLKS,
};
enum clk_id cmucal_vclk_ad_axi_dspm2[] = {
	GOUT_BLK_DSPM_UID_AD_AXI_DSPM2_IPCLKPORT_ACLKM,
	GOUT_BLK_DSPM_UID_AD_AXI_DSPM2_IPCLKPORT_ACLKS,
};
enum clk_id cmucal_vclk_axi2ahb_dspm[] = {
	GOUT_BLK_DSPM_UID_AXI2AHB_DSPM_IPCLKPORT_CLK,
};
enum clk_id cmucal_vclk_axi2apb_dspm[] = {
	GOUT_BLK_DSPM_UID_AXI2APB_DSPM_IPCLKPORT_ACLK,
};
enum clk_id cmucal_vclk_baaw_dspm[] = {
...
enum clk_id cmucal_vclk_btm_dspm2[] = {
	GOUT_BLK_DSPM_UID_BTM_DSPM2_IPCLKPORT_I_ACLK,
	GOUT_BLK_DSPM_UID_BTM_DSPM2_IPCLKPORT_I_PCLK,
};
enum clk_id cmucal_vclk_cnn[] = {
	GOUT_BLK_DSPM_UID_CNN_IPCLKPORT_ASYNCDAPM_DAPCLK,
	GOUT_BLK_DSPM_UID_CNN_IPCLKPORT_Clk,
	GOUT_BLK_DSPM_UID_CNN_IPCLKPORT_HCLK,
};
...
enum clk_id cmucal_vclk_ppmu_dspm2[] = {
	GOUT_BLK_DSPM_UID_PPMU_DSPM2_IPCLKPORT_ACLK,
	GOUT_BLK_DSPM_UID_PPMU_DSPM2_IPCLKPORT_PCLK,
};
...
enum clk_id cmucal_vclk_sysmmu_dspm2[] = {
	GOUT_BLK_DSPM_UID_SYSMMU_DSPM2_IPCLKPORT_CLK,
};
...
/* GATING VCLK */
	...
	CMUCAL_VCLK(VCLK_AD_APB_DSPM2, NULL, cmucal_vclk_ad_apb_dspm2, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_AD_APB_DSPM5, NULL, cmucal_vclk_ad_apb_dspm5, NULL, NULL),
	CMUCAL_VCLK(VCLK_AD_AXI_DSPM0, NULL, cmucal_vclk_ad_axi_dspm0, NULL, NULL),
	CMUCAL_VCLK(VCLK_AD_AXI_DSPM1, NULL, cmucal_vclk_ad_axi_dspm1, NULL, NULL),
	CMUCAL_VCLK(VCLK_AD_AXI_DSPM2, NULL, cmucal_vclk_ad_axi_dspm2, NULL, NULL),
	CMUCAL_VCLK(VCLK_AXI2AHB_DSPM, NULL, cmucal_vclk_axi2ahb_dspm, NULL, NULL),
	CMUCAL_VCLK(VCLK_AXI2APB_DSPM, NULL, cmucal_vclk_axi2apb_dspm, NULL, NULL),
	CMUCAL_VCLK(VCLK_BAAW_DSPM, NULL, cmucal_vclk_baaw_dspm, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_BTM_DSPM2, NULL, cmucal_vclk_btm_dspm2, NULL, NULL),
	CMUCAL_VCLK(VCLK_CNN, NULL, cmucal_vclk_cnn, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_PPMU_DSPM2, NULL, cmucal_vclk_ppmu_dspm2, NULL, NULL),
	...
	CMUCAL_VCLK(VCLK_SYSMMU_DSPM2, NULL, cmucal_vclk_sysmmu_dspm2, NULL, NULL),
...
unsigned int cmucal_vclk_size = 485;
